(() => {
    ...
    const steps = [
        ...
        },
        {
            ...
            paragraphs: [
                'Спойлер: из всего бэка понравился только он.',
        ...
        },
        {
            ...
            paragraphs: [
                '1. HTML — понятно что куда зачем.',
                '2. CSS — всё ещё понятно что куда зачем.',
                '3. JavaScript — понравился больше, чем Python, чем конкретно — не имею понятия, вайбовый.',
        ...
        },
        {
            ...
            title: '6 Тестировщик',
            paragraphs: [
                '1 Мне иногда проще целиком снести всё, что сделал другой человек и сделать заново как мне надо.',
                '2 Ненавижу искать ошибки в чужой работе. Я в своей то их ненавижу искать.',
                '3 Понимаю, что заниматься этим всё равно придется — но не хочу это видеть как основное занятие.',
                '4 Инженер по безопасности как будто туда же.'
            ]
        },
        {
            type: 'text',
